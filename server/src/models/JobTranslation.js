...
const jobTranslationSchema = new mongoose.Schema({
  ...
  shortDescription: { type: String, default: "", trim: true },   // za listu/karticu
  intro: { type: [String], default: [] },                         // umesto mock intro
  whyThisPosition: { type: String, default: "", trim: true },
  aboutZepter: { type: String, default: "", trim: true },

  qualifications: { type: [String], default: [] },               // tagovi iz detail-a
...
}, { timestamps: true, collection: "jobTranslations" });
